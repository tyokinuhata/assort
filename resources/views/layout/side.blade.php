<div class="side_menu">
    ...
    <div class="menu_item">
        <a href="/payment_search" class="menu_block_name">入金管理</a>
    </div>
    <div class="menu_item">
        <a href="/spending_search" class="menu_block_name">出金管理</a>
    </div>
    <div class="menu_item">
        <a href="/sales_search" class="menu_block_name">売上管理</a>
    </div>
    <div class="menu_item">
        <a class="menu_block_name has_submenu">カテゴリ管理</a>
        <div class="menu_block_hiden">
            <a href="/category_search" class="menu_block_subitem">子カテゴリ管理</a>
            <a href="/parent_category_search" class="menu_block_subitem">親カテゴリ管理</a>
        </div>
    </div>
    <div class="menu_item">
        ...
        <div class="menu_block_hiden">
            ...
            <a href="/shelf_search" class="menu_block_subitem">棚番号管理</a>
        </div>
    </div>
</div>